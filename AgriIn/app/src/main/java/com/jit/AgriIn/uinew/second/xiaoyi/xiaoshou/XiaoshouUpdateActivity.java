 ...
 *         discription: 新增塘口配置
 */
public class XiaoshouUpdateActivity extends BaseActivity<GudingUpdateView,GudingUpdatePresenter> implements GudingUpdateView {
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        mTvToolbarTitle.setText("修改销售金额");
        mTvPublishNow.setVisibility(View.VISIBLE);
        mTvPublishNow.setText(R.string.submit);


        tvGoumaiType.setText("销售种类");
        tvGoumaiTotal.setText("销售金额");
        mTvGudingType.setHint("请选择销售类型");
        mEtGudingPrice.setHint("请输入销售金额");
    ...
    protected void initListener() {
        ...
        mTvGudingType.setOnClickListener(view -> mPresenter.getXiaoshouType());
    ...
    private void checkFormatData() {
        ...
        if (!NetworkHelper.isNetworkAvailable(this)){
            ...
            doPondAddCommit(gudingType,Integer.valueOf(price),time,rizhiContent,shuliang,unit);
        }
    }


    private void doPondAddCommit(String gudingName, int gudingPrice,String time,String des,String count,String unit) {
        mPresenter.updateIncome(2,gudingName,gudingPrice,time,des,count,unit,mGudingId);
    }
