...
import com.jit.AgriIn.ui.presenter.baike.BaikeDrugShowAtPresenter;
...
/**
 * @author crazyZhangxl on 2018-10-26 16:49:35.
 * Describe:
 */

public class BaikeShDrugActivity extends BaseActivity<BaikeDrugShowAtView, BaikeDrugShowAtPresenter> implements BaikeDrugShowAtView {
    ...
    protected int provideContentViewId() {
        return R.layout.activity_baike_sh_drug;
    }

    @Override
    protected BaikeDrugShowAtPresenter createPresenter() {
        return new BaikeDrugShowAtPresenter(this);
    }
    ...
    @Override
    public void queryBaikeShowSuccess(BaikeDrugBean baikeSeedResponse) {
        if (baikeSeedResponse != null){
//            GlideLoaderUtils.display(this,mIvOnePhoto, baikeSeedResponse.getImage());
            mTvCompany.setText(getString(R.string.baike_source, baikeSeedResponse.getFromSource()));
            mTvTitle.setText(getString(R.string.baike_name,baikeSeedResponse.getName()));
