 ...
 *         discription: 新增塘口配置
 */
public class XiaoshouAddActivity extends BaseActivity<GudingAddView,GudingAddPresenter> implements GudingAddView {
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        mTvToolbarTitle.setText("添加销售金额");
    ...
    private void doPondAddCommit(String gudingName, int gudingPrice,String time,String des,String count,String unit) {
        mPresenter.addIncome(2,gudingName,gudingPrice,time,des,count,unit);
    }
