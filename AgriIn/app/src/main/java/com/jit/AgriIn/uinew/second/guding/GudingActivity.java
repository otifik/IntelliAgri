...
public class GudingActivity extends BaseActivity<GudingView,GudingPresenter> implements GudingView{
    ...
    protected void initListener() {
        ...
        ibAddMenu.setOnClickListener(view -> jumpToActivity(GudingAddActivity.class));
...
//        jumpToActivity(intent);
    ...
    public void jumpToPondEdit(int itemPosition){
        ...
        Intent intent = new Intent(this, GudingUpdateActivity.class);
