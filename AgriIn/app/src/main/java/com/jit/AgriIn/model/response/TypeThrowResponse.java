...
public class TypeThrowResponse {
    /**
    ...
    private int pages;
    private int total;
    private List<DailyThrowResponse> list;
    ...
    public List<DailyThrowResponse> getList() {
        return list;
    }

    public void setList(List<DailyThrowResponse> list) {
        this.list = list;
    }
}
