...
import com.jit.AgriIn.ui.activity.baike.BaikeShProductActivity;
import com.jit.AgriIn.ui.activity.role_expert.EBKProductAddActivity;
import com.jit.AgriIn.ui.activity.role_expert.EBKProductUpdateActivity;
import com.jit.AgriIn.ui.activity.role_expert.RoleExpertActivity;
import com.jit.AgriIn.ui.presenter.baike.BaikeProductFgPresenter;
 ...
 */
public class EBKProductFragment extends BaseFragment<BaikeProductFgView, BaikeProductFgPresenter> implements BaikeProductFgView {
    ...
    protected BaikeProductFgPresenter createPresenter() {
        return new BaikeProductFgPresenter((RoleExpertActivity) getActivity());
    }

    @Override
    public void initView(View rootView) {
        mBtnAddBaike.setText("添加产品百科");
        initAdapter();
    }

    private void initAdapter() {
        mRecBaike.setLayoutManager(new LinearLayoutManager(getActivity(),LinearLayoutManager.VERTICAL,false));
        mAdapter = new BaseQuickAdapter<BaikeProductBean, BaseViewHolder>(R.layout.item_baike_selection,mList) {
            @Override
...
//                helper.setText(R.id.tvType,item.getSubKind());
    ...
    public void initListener() {
        ...
        mBtnAddBaike.setOnClickListener(v -> jumpToActivity(EBKProductAddActivity.class));
