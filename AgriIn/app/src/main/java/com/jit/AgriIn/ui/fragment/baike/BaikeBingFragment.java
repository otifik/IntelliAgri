 ...
 * Describe:
 */
public class BaikeBingFragment extends BaseFragment {
    ...
    public static BaikeBingFragment newInstance() {

        Bundle args = new Bundle();

        BaikeBingFragment fragment = new BaikeBingFragment();
    ...
    public void initView(View rootView) {
        ...
        mTitleList.add("其他");
        mTitleList.add("所有");
        mFragments.add(BaikeDiseaseListFragment.newInstance("鱼类"));
        mFragments.add(BaikeDiseaseListFragment.newInstance("虾类"));
        mFragments.add(BaikeDiseaseListFragment.newInstance("蟹类"));
        mFragments.add(BaikeDiseaseListFragment.newInstance("其他"));
