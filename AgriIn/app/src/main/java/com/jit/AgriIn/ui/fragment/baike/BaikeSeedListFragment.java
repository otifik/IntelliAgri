 ...
 */
public class BaikeSeedListFragment extends BaseFragment<BaikeCustomFgView, BaikeSeedFgPresenter> implements BaikeCustomFgView {
    ...
    public static BaikeSeedListFragment newInstance(String param1) {
        BaikeSeedListFragment fragment = new BaikeSeedListFragment();
    ...
    protected BaikeSeedFgPresenter createPresenter() {
        return new BaikeSeedFgPresenter((BaikeDetailActivity) getActivity());
    }
...
//                Log.e("种苗imageUrl",item.getImage());
