...
public class GoumaiActivity extends BaseActivity<GudingView,GudingPresenter> implements GudingView{
    ...
    private void setAdapter() {
        ...
        mPondMainAdapter = new BaseQuickAdapter<IncomeResponse, BaseViewHolder>(R.layout.item_guding,mIncomeResponses
            ...
            protected void convert(BaseViewHolder helper, IncomeResponse item) {
                helper.setText(R.id.tvGoumai,"购买金额");
    ...
    protected void initListener() {
        ...
        ibAddMenu.setOnClickListener(view -> jumpToActivity(GoumaiAddActivity.class));
...
//        jumpToActivity(intent);
    ...
    public void jumpToPondEdit(int itemPosition){
        ...
        Intent intent = new Intent(this, GoumaiUpdateActivity.class);
