...
public class MyAttrsUtils {
     ...
     * @return
     */
    public static int getTypeValueColor(Context mContext,
                                        int attr) {
     ...
     * @return
     */
    public static boolean getTypeValueBoolean(Context mContext,
                                              int attr) {
        TypedValue typedValue = new TypedValue();
        int[] attribute = new int[]{attr};
        TypedArray array = mContext.obtainStyledAttributes(typedValue.resourceId, attribute);
     ...
     * @return
     */
    public static Drawable getTypeValuePopWindowImg(Context mContext,
                                                    int attr) {
        TypedValue typedValue = new TypedValue();
        int[] attribute = new int[]{attr};
        TypedArray array = mContext.obtainStyledAttributes(typedValue.resourceId, attribute);
