...
import com.zxl.baselib.util.window.Direction;
...
public class ViewHelper {
    ...
    public static
    @Nullable
    TranslateAnimation slideIn(final View view,
                               int duration,
     ...
     * <p>相关方法 {@link (View, int, Animation.AnimationListener, boolean, Direction)}</p>
     *
     * @param view            做动画的 View
     * @param duration        动画时长(毫秒)
     * @param listener        动画回调
    ...
    public static
    @Nullable
    TranslateAnimation slideOut(final View view,
                                int duration,
                                final Animation.AnimationListener listener,
    ...
    public static View findViewFromViewStub(View parentView,
                                            int viewStubId,
                                            int inflatedViewId,
