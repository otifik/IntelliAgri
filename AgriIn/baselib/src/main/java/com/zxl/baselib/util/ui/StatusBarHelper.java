...
import com.zxl.baselib.util.window.DeviceHelper;
import com.zxl.baselib.util.window.DisplayHelper;
import com.zxl.baselib.util.window.NotchHelper;
import com.zxl.baselib.util.window.SystemUiVisibilityUtils;
...
//            }
    ...
    public static void showStatusBar(Activity activity){
        SystemUiVisibilityUtils.enter(activity);
    }

    public static void hideStatusBar(Activity activity){
        SystemUiVisibilityUtils.exit(activity);
    }
