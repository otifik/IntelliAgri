...
public class QuestionServiceImpl implements QuestionService {
     ...
     */
    @Override
    public Question insertQuestion(MultipartFile image, String description) throws IOException {
...
//        question.setType(Integer.parseInt(request.getParameter("type")));
        ...
        if (image != null) {
            ...
            question.setImage(url + image_url + fileName);
        }
     ...
     */
    @Override
    public Question updateQuestion(MultipartFile image, String description, Integer id) throws IOException {
//        String username = SecurityContextHolder.getContext().getAuthentication().getName();
        String username = UserInfoContext.getUser().getUsername();
