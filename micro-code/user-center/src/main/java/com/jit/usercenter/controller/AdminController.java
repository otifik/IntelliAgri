...
public class AdminController {
    ...
    @PostMapping("add")
    User addUser(@RequestBody User userDO,@RequestParam("username")String username) {
        return userService.addUser(userDO,username);
    }
    ...
    Boolean deleteUserInfo(@RequestParam("userId") Integer userId,@RequestParam("username")String username) {
        return userService.deleteUserInfo(userId,username);
    }
