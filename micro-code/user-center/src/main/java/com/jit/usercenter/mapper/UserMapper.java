...
import com.jit.usercenter.commons.util.DynamicSql;
...
//    User findByUsername(@Param("username") String username);
    ...
    @Select("select role as name,count(*) as value from user where role=#{name} ")
    ShowDto selectRoleNum(@Param(("name")) String name);
    ...
    List<DriverInfo> getByDriverTel(@Param("belongUserId") Integer belongUserId, @Param("tel") String tel);
